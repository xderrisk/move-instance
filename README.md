...
An extension for GNOME Shell that automatically moves single-instance applications (or specific apps via WM_CLASS) to the current workspace when dragged from the Dock.
